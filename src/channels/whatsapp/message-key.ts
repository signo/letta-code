 ...
 *
 * In Baileys v6 the key shape is `{ remoteJid, id, fromMe, participant, senderPn }`.
 * Baileys v7 may rename or restructure these fields. By routing all field access
 * through this single accessor, the v7 migration becomes a one-file change.
 *
